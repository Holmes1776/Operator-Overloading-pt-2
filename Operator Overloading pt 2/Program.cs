...
namespace Assignment9ex2Operatoroverloading
{
    public class Log
    {
        ...
        // overloaded operator + and operator -
        public static Log operator +(Log left, Log right) 
        {
            ...
            while (selection != 6)
            {
                switch (selection)
                {
                    ...
                    case 5:
                        ...
                        if (totalFun.Hours > totalWork.Hours && totalFun.Hours > totalOther.Hours)
                        {
                        ...
                        else if (totalWork.Hours > totalFun.Hours && totalWork.Hours > totalOther.Hours)
                        {
